...
2.0 20070116
进行修改，增加了端口设置，客户端连接断开的侦听，服务器的建立与销毁，发信的逻辑判断

3.0 20070116
修改了接收和发送函数，不使用CArchive。

================================================================================
    MICROSOFT 基础类库： NetSevTest 项目概述
===============================================================================

应用程序向导已为您创建了此 NetSevTest 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 NetSevTest 应用程序的每个文件的内容摘要。
...
NetSevTest.h
    ...
    CNetSevTestApp 应用程序类。

NetSevTest.cpp
    这是包含应用程序
    类 CNetSevTestApp 的主应用程序源文件。
...
应用程序向导将创建一个对话框类：
NetSevTestDlg.h、NetSevTestDlg.cpp - 对话框
    这些文件包含 CNetSevTestDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    NetSevTest.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 NetSevTest.pch 的预编译头文件 (PCH)
