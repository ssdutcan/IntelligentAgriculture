...
public class DownloadService extends Service{
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		// TODO Auto-generated method stub
		FarmInfo farmInfo = (FarmInfo)intent.getSerializableExtra("farmInfo");
...
//		private String ipv4 = "10.10.250.211";
		...
		public void run() {
			// TODO Auto-generated method stub
//			String farmUrl = "http://192.168.10.236:8080/farm/" + this.farmInfo.getFarmName();
			String farmUrl = "http://"+ ipv4 +":8080/farm/" + this.farmInfo.getName();
			HttpDownloader httpDownloader = new HttpDownloader();
			int result = httpDownloader.downFile(farmUrl, "farm/", this.farmInfo.getName());
		}
